              ...
              <div className="w-full md:w-1/2 px-3 order-1 md:order-1">
                <div className="max-w-md-2">
                  ...
                  <p
                    ...
                    data-wow-delay=".1s"
                  >
                    At Avant-garde-Finance, we are dedicated to offering
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-blueGray-400 leading-loose text-sm">
                          At Avant-garde-Finance, we prioritize the safety of
...
>
  ...
  <div className="whyChooseBodyHold">
    ...
    >
      ...
      <p>
        At Avant-garde-finance, we prioritize the safety of your
...
//                                 <img className="sm:max-w-sm lg:max-w-full mx-auto" src="/imgs/placeholders/img-6.jpg" alt="Avant-garde-Finance" />
//                             </div>
//                             <div className="w-full md:w-1/2 px-3 order-1 md:order-1">
//                                 <div className="max-w-md-2">
//                                     <div className="mb-4">
...
//                                         At Avant-garde-Finance, we are dedicated to offering comprehensive banking services tailored to meet your financial needs.
//                                     </p>
...
//                             </div>
//                             <div className="w-full lg:w-1/2">
//                                 <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn">At Avant-garde-Finance, we prioritize your financial success and provide expert guidance and support every step of the way.</p>
//                             </div>
//                         </div>
